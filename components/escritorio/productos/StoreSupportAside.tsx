...
export function StoreSupportAside({
  locationAddress = "Av. Los Proceres 123",
  locationDistrict = "San Martin de Porres, Lima",
  onLocationClick,
  onSuggestionClick,
  whatsappUrl = "https://wa.me/51924516682",
}: StoreSupportAsideProps) {
  const supportItems = [
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm transition-colors duration-300 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-4 flex gap-3">
          ...
          <div className="text-sm text-zinc-700 dark:text-zinc-300">
            ...
            <p className="mt-1 text-zinc-500 dark:text-zinc-400">{locationDistrict}</p>
            <button
